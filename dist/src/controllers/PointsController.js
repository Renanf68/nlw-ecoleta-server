...
var PointsController = /** @class */ (function () {
    ...
    PointsController.prototype.index = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, city, uf, items, points, parsedItems, serializedPoints;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        points = _b.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, connection_1.default("points")
                            .where("city", String(city))
                            .where("uf", String(uf))
                            .distinct()
                            .select("points.*")];
                    ...
                    case 4:
                        serializedPoints = points.map(function (point) {
                            return __assign(__assign({}, point), { image: "http://localhost:3333/uploads/" + point.image });
                        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        serializedPoint = __assign(__assign({}, point), { image: "http://localhost:3333/uploads/" + point.image });
